  ...
  getBlinds(): Blind[] {
    return [
      ...
      },
      {
        ...
        name: "Zasłony",
        info:
          "Ten typ dekoracji stanowi efektowną ozdobę nie tylko mieszkań" +
        ...
        info1:
          "Wysoka jakość materiałów i szeroki wybór wzorów gwarantuje wysoki stopień" +
      ...
      },
      {
        ...
        name: "Rzymskie",
        info:
          "Znakiem charakterystycznym rolet rzymskich jest" +
      ...
      },
      {
        ...
        name: "Plisy",
        info:
          "Plisy to idealne rozwiązanie dla wszystkich, którym zależy" +
          "na precyzyjnej regulacji ilości wpadającego do pomieszczenia świata.",
        info1:
          " Dają one możliwość zasłonięcia dowolnego fragmentu okna tak aby stworzyć" +
      ...
      },
      {
        ...
        name: "Markizy",
        info:
          "Podstawowym zadaniem markizy jest ochrona przeciwsłoneczna" +
          "np. tarasu, balkonu, ogródka restauracyjnego czy zewnętrznego stoiska.",
        info1:
          "Pełnią one nie tylko rolę zaciemniającą, ale także stanowią niezwykle" +
      ...
      },
      {
        ...
        name: "Zewnętrzne",
        info:
          "Rolety zewnętrzne cieszą się największym zainteresowaniem," +
          "a zawdzięczają to swojej wielofunkcyjności oraz wysokiej estetyce.",
        info1:
          "Parametry rolety można odpowiednio dobrać tak, aby kolorystycznie" +
      ...
      },
      {
        ...
        name: "Moskitiery",
        info:
          "Moskitiery to idealny sposób na walkę z wszelkimi insektami," +
          "które po otwarciu okien czy drzwi próbują przedostać się do naszego" +
          "mieszkania.",
        info1:
          "Różne sposoby otwierania pozwolą Ci wybrać najwygodniejszy" +
      ...
      },
      {
        ...
        info:
          "Drewno to materiał, którego użycia sprawia, że" +
          "przytulność i ciepło danego pomieszczenia znacznie wzrasta.",
        info1:
          "Sprawdzą się idealnie gdy zależy nam na eko wyglądzie naszej kuchni," +
          "sypialni czy salonu.",
      },
      {
        id: 11,
        ...
        name: "Bramy",
        info:
          "Bramy tego typu znajdują zastosowanie nie tylko w budynkach mieszkalnych, ale także przemysłowych." +
          "Mechanizm jest w pełni zautomatyzowany z możliwością otwierania awaryjnego.",
        info1:
          "Profile bramy, która jest wykonana z aluminium są wypełnione pianką poliuretanową." +
